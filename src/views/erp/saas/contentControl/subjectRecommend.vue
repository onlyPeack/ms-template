    ...
    <list-container :timeStamp="timeStamp" :page="listQuery" @reload="getList" class="app-container calendar-list-container goods-list-container" >
            ...
            <el-col style='padding-left:10px;'>
                ...
                <div class="filter-container" style="background: #ffffff;padding-top: 20px;padding-left: 20px;">
                    <el-form :inline="true">
                        <el-form-item label="关键字:">
                            <el-input clearable class="filter-item" style="width: 200px;" placeholder="请输入关键字" v-model="listQuery.categoryName"></el-input>
                        </el-form-item>
                        <el-form-item label="推荐状态:">
                            <el-select v-model="listQuery.level" placeholder="请选择推荐状态">
                ...
                <div class="result-container"style="padding: 0% 1%; background: #ffffff;">
                    <el-table size="small" :data="list" v-loading="listLoading" @selection-change="handlechangeFun"
                        ...
                        <el-table-column align="center" min-width="100" label="关键字" prop="categoryName">
                        </el-table-column>
                        ...
                        <el-table-column align="center" min-width="100" label="海报图" prop="pic" v-slot="{row}">
                            <div @click="doShowImageViewer(row.pic)" style="cursor: pointer">
                                <el-image :src="row.pic" :url-list="srcList" fit="contain" style="width: 60px"></el-image>
                            </div>
                        </el-table-column>
                        <el-table-column align="center" min-width="100" label="推荐状态" prop="recommendStatus" >
                            <template slot-scope="scope">
                                {{scope.row.recommendStatus===0?'未推荐':'推荐中'}}
                            </template>
                        </el-table-column>
        ...
        <el-dialog modal-append-to-body
            ...
            <el-form :rules="rules" ref="addList" :model="addList" status-icon label-position="right" label-width="140px" size="medium">
                ...
                <el-form-item label="关键字" prop="categoryName" >
<!--                    <div @click="showBrandSelector=true">-->
                    <div style="display: inline-block;width: 300px">
                        <el-input v-model="addList.categoryName" placeholder="请输入关键字">
                    ...
                    <div style="display: inline-block;margin-left: 15px;">
                        <el-tooltip effect="dark">
                            <div slot="content">搜索词,点击可搜索相关产品</div>
                            <img src="http://hejigy.com.cn/questionMarksBlue.png" alt="">
                        </el-tooltip>
                    </div>
...
<!--                    </div>-->
                ...
                <el-form-item label="是否推荐">
                    <el-radio-group v-model="addList.recommendStatus">
...
<script>
    ...
    import {page as pages,addSubjectRecommend,updateSubjectRecommend,deleteSubjectRecommend} from '@/api/erp/saas/contentControl/subjectRecommend';
        ...
        methods: {
            ...
            handleDelete() {
                ...
                this.$confirm('此操作将永久删除, 是否继续?', '提示', {
                    ...
                    deleteSubjectRecommend(ids).then(res => {
            ...
            listSubmit(){
                this.$refs['addList'].validate((valid) => {
                    if (valid) {
                        ...
                        let method=this.dialogStatus==='create'?addSubjectRecommend:updateSubjectRecommend
                        let message=this.dialogStatus==='create'?"专题推荐新增":"专题推荐编辑"
