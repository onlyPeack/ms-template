            ...
            <div class="avue-crud-container" v-if="isShow">
                <avue-crud ref="crud" class="avue-crud-left-index"
                    ...
                    <template slot="menuLeft">
                        ...
                        <el-button icon="el-icon-circle-close"  type="danger" v-if="clock" plain @click="clockBtn">结束初始化</el-button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleAdd() {
                this.handleBillAdd(this,{path: '/receivable-init-form', name: '应收初始化制单'});
            },
            //获取数据
            getList(page, params = {}) {
                this.loading = true;
