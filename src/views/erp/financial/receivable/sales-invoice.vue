<template>
    <list-container :timeStamp="timeStamp" :page="page" @reload="getList">
        ...
        <a id="test123" :href="openUrl+'/api/manager/financial-sales-invoice/exportDetail?id='+(selectedRows&&selectedRows.length>0?selectedRows[0].id:'')"></a>
    </list-container>
</template>

<script>
    import { batchDelBill, selectPage, selectPageByItem } from '@/api/erp/financial/financialSalesInvoice'
    ...
    export default {
        ...
        methods: {
            ...
            handleAdd() {
                this.handleBillAdd(this,{path: '/sales-invoice-form', name: '销售发票制单'});
            },
            handleSwitchChange() {
                this.isShow = false;
                this.$nextTick(() => {
