...
<script>
    ...
    import {page as capitalAccount,stockSummary} from '@/api/erp/financial/financialCapitalAccount';
    ...
    export default {
        ...
        methods: {
            ...
            //获取数据
            getList(page, params = {}) {
                stockSummary(this.listQuery.accountCode).then(res=>{
                    console.log()
                    this.dataObj = res.data.data;
                })
                this.loading = true;
                let queryObj = Object.assign(params, this.listQuery, {page: page.currentPage, limit: page.pageSize,selectType: "5"});
