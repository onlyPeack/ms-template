...
<script>
    import {page as pages} from '@/api/erp/financial/financialPayableDetail'
    export default {
        name: "payable-statistics",
        data() {
            return {
                isShow: true,
                searchDisable: false,
            ...
            getList(page, params = {}) {
                ...
                select(queryObj).then(res => {
                    ...
                    for(let i in data.records){
                        data.records[i].type = '付款'
                        data.records[i].notPayAmount = data.records[i].amount - data.records[i].payAmount
                    }
