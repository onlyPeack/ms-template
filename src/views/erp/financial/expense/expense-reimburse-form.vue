...
<script>
    ...
    import {getBill, getHistoryBill, addBill, tempAddBill,auditBill} from  "@/api/erp/financial/financiaCostReimbursement";
        ...
        methods: {
            ...
            handleSubmit(type) {
                ...
                this.$refs['form'].validate((valid) => {
                    if (valid) {
                        //防止重复提交
                        if(this.formData.bankAccount.length<16 || this.formData.bankAccount.length>19){
                            this.vueMessage('warning','银行账户只能为16-19位之间');
                            return
                        }
