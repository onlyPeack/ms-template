...
<script>
    import {selectPage, selectPageByItem, batchDelBill} from "@/api/erp/product/product_config/product_production_craft";
    ...
    export default {
        ...
        methods: {
            ...
            handleAdd() {
                this.handleBillAdd(this,{path: '/product_craft_managerment_form', name: '工艺管理制单'});
            },
            handleSwitchChange() {
                this.isShow = false;
                this.$nextTick(() => {
