...
<script>
    import {selectPage, selectPageByItem, batchDelBill} from "@/api/erp/product/shop_manager/product_order_changes";
    export default {
        name: "product_order_changes",
        props: ['timeStamp'],
        components: {
        ...
        methods: {
            ...
            handleAdd() {
                this.handleBillAdd(this,{path: '/product_order_changes_form', name: '生产订单变更单制单'});
            },
            handleSwitchChange() {
                this.isShow = false;
                this.$nextTick(() => {
