            ...
            <div class="avue-crud-container" v-if="isShow">
                <avue-crud ref="crud"
                    ...
                    <template slot="menuLeft">
                        <a :href="'/api/manager/sales-detail/exportSalesInvoice?id='+ id" >
...
<script>
    import {pageSalesInvoice as selectPage} from '@/api/erp/financial/financialReceivableDetail'
    export default {
        name: "sales_invoice_warning",
        props: ['timeStamp'],
        data() {
            return {
                id: undefined,
