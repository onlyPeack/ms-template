            ...
            <div class="avue-crud-container" v-if="isShow">
                <avue-crud ref="crud"
                    ...
                    <template slot="menuLeft">
                        <a :href="'/api/manager/sales-detail/exportSalesReceive?id='+ id">
...
<script>
    import {pageSalesReceive as selectPage} from '@/api/erp/financial/financialReceivableDetail'
    export default {
        name: "sales_receive_warning",
        props: ['timeStamp'],
        data() {
            return {
                id: undefined,
