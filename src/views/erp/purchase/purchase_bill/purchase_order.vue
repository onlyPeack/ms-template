...
<!--                                <el-dropdown-item v-if="!isDetailed">-->
...
<!--                                </el-dropdown-item>-->
<!--                                <el-dropdown-item  v-if="!isDetailed">-->
<!--                                    <div class="manyOpt" @click="handleDownLoad">&nbsp;&nbsp;&nbsp;&nbsp;打印合同</div>-->
<!--                                </el-dropdown-item>-->
<!--                                <el-dropdown-item>-->
<!--                                    <div class="manyOpt" @click="positionBtn">&nbsp;&nbsp;&nbsp;&nbsp;跟踪</div>-->
<!--                                </el-dropdown-item>-->
<!--                            </el-dropdown-menu>-->
<!--                        </el-dropdown>-->
...
<script>
    import {batchDelBill, selectPage, selectPageByItem} from '@/api/erp/purchase/bill/purchaseOrder'
            ...
            return {
                ...
                tableOption: {
                    ...
                    sumColumnList: [
                        ...
                        {
                            name: "notStockInPurchaseQty",
                            type: "sum",
                            len: 0
                        },
                        {
                            name: "notStockInPurchaseAmount",
                            type: "sum"
                        },
                        {
                            name: "stockReturnQty",
