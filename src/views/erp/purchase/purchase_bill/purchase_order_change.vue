...
<script>
    import {selectPage, selectPageByItem, batchDelBill} from "@/api/erp/purchase/bill/purchase_order_change";

    export default {
        name: "purchase_order_change",
        props: ['timeStamp'],
        components: {
        ...
        methods: {
            ...
            handleAdd() {
                this.handleBillAdd(this,{path: '/purchase_order_change_form', name: '采购订单变更制单'});
            },
            handleSwitchChange() {
                this.isShow = false;
                this.$nextTick(() => {
