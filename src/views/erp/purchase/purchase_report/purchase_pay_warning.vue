            ...
            <div class="avue-crud-container" v-if="isShow">
                <avue-crud ref="crud"
                    ...
                    <template slot="menuLeft">
                        <a :href="'/api/manager/purchase-detail/exportPurchasePay?id='+ id" >
...
<script>
    import {pagePurchasePay  as selectPage} from '@/api/erp/financial/financialReceivableDetail'
    export default {
        name: "purchase_pay_warning",
        props: ['timeStamp'],
        data() {
            return {
                id: undefined,
