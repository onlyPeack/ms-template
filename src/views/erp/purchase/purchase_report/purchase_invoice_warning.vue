            ...
            <div class="avue-crud-container" v-if="isShow">
                <avue-crud ref="crud"
                    ...
                    <template slot="menuLeft">
                        <a :href="'/api/manager/purchase-detail/exportPurchaseInvoice?id='+ id" >
...
<script>
    import {pagePurchaseInvoice  as selectPage} from '@/api/erp/financial/financialReceivableDetail'
    export default {
        name: "purchase_invoice_warning",
        props: ['timeStamp'],
        data() {
            return {
                id: undefined,
