...
<script>
    import {batchDelBill, selectPage, selectPageByItem} from "@/api/erp/wms/bill/combind";
    ...
    export default {
        ...
        methods: {
            ...
            handleAdd() {
                this.handleBillAdd(this,{path: '/combind_form', name: '组装拆卸单制单'});
            },
            handleSwitchChange() {
                this.isShow = false;
                this.$nextTick(() => {
