    ...
    <div class="contractPrintContainer" :style="{width:containerWidth}" style="overflow: auto;">
        <div class="print-box" id="printBox">
            <div class="print-container">
                ...
                <div class="print-title">生产入库订单</div>
                ...
                <table class="formTable">
                    ...
                    <tr>
                        <td>
                            <span class="label">操作员:</span>{{dataForm.operatorName}}
                        </td>
                        <td>
                ...
                <table class="formTable itemsTable">
                    ...
                    <tr v-for="(scope,index) in items">
                        ...
                        <td align="right">{{scope.positionName}}</td>
...
<script>
    ...
    import {addBill, getBill, tempAddBill, auditBill} from '@/api/erp/wms/bill/productStockIn';
    import "@/styles/print.scss";
    import {getFloat} from '@/util/util'
    import {pageAll} from '@/api/erp/financial/financialPaymentsMeans';

    export default {
        name: "product_stock_in_print",
        data() {
            return {
                containerWidth: '70%',
                dataForm: {
