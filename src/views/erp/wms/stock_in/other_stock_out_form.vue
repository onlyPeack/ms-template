    ...
    <bill-container @reload="reload" :type="type" :id="id" ref="billContainer">
        <basic-container v-loading="loading">
            <div class="viewData" style="position: relative;justify-content: unset">
                <div>
                    ...
                    <router-link v-if="type == 'view' && formData && formData.billStatus == '4'" target="_blank"
                                 :to="{path:'/print/other_stock_out_print',query:{id:id}}">
                    ...
                    <template slot-scope="scope" slot="items">
                        <avue-crud :option="itemsOption" :data="formData.items" ref="crud"  :class="type == 'view'?'':'main-form-items'" :summary-method="getSummaries"
                            ...
                            <template slot-scope="scope" slot="price">
                                <div class="zRightClass">
                                    <el-input v-model="scope.row.price" placeholder="请输入出库单价"
            ...
            <pubil-selector v-if="publicVisible" ref="publicSelector" :dialogVisible="publicVisible"
                            :itemVisible="itemVisible" :code="formData.warehouseId"
...
<script>
    ...
    import {getBill, getHistoryBill, addBill, tempAddBill} from "@/api/erp/wms/bill/otherStockOut";
            ...
            positionBtn(val, index) {
                if (this.type != 'view') {
                    ...
                    if (this.formData.items[index] && this.formData.items[index].skuNo) {
                        ...
                        this.vueMessage('warning', '请先选入商品');
                        return
                    }
            ...
            skuBtn(item, index, type) {
                if (this.type != 'view') {
                    if(this.formData.warehouseName !=''){
                        ...
                        this.vueMessage('warning','请先选择出库仓库!');
                        return
                    }
                }
