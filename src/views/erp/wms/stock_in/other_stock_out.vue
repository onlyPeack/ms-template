...
<script>
    import {selectPage, selectPageByItem, batchDelBill} from "@/api/erp/wms/bill/otherStockOut";
    import {openUrl} from '@/config/env';
    export default {
        name: "other_stock_out",
        props: ['timeStamp'],
        components: {
        ...
        methods: {
            ...
            handleAdd() {
                this.handleBillAdd(this,{path: '/other_stock_out_form', name: '其它出库制单'});
            },
            handleSwitchChange() {
                this.isShow = false;
                this.$nextTick(() => {
            ...
            handleExport() {
                ...
                window.open(openUrl+"/api/manager/quotation-prices/exQuotationPricesOrder?id=" + this.selectedRows[0].id);
