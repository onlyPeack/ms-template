    ...
    <div class="contractPrintContainer" :style="{width:containerWidth}" style="overflow: auto;">
        <div class="print-box" id="printBox">
            <div class="print-container">
                ...
                <div class="print-title">采购入库订单</div>
                ...
                <table class="formTable">
                    ...
                    <tr>
                        <td>
                            <span class="label">入库仓库:</span>{{dataForm.warehouseName}}
                        </td>
                        <td>
...
<script>
    ...
    import {addBill, getBill, tempAddBill, auditBill} from '@/api/erp/wms/bill/purchaseStockIn';
