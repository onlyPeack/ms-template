...
<script>
    import {selectPage, selectPageByItem, batchDelBill} from "@/api/erp/wms/bill/otherStockIn";
    ...
    export default {
        ...
        methods: {
            ...
            handleAdd() {
                this.handleBillAdd(this,{path: '/other_stock_in_form', name: '其它入库制单'});
            },
            handleSwitchChange() {
                this.isShow = false;
                this.$nextTick(() => {
