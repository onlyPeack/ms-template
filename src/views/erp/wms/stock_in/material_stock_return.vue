...
<script>
    import { batchDelBill, selectPage, selectPageByItem } from '@/api/erp/wms/bill/stockMaterialReturn'
    export default {
        name: "material_stock_return",
        components: {
        ...
        methods: {
            handleAdd() {
                this.handleBillAdd(this,{path: '/material_stock_return_form', name: '退料入库单制单'});
            },
            handleSwitchChange() {
                this.isShow = false;
                this.$nextTick(() => {
