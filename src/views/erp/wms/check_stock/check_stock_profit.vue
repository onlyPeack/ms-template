...
<script>
    import {selectPage, selectPageByItem, batchDelBill} from '@/api/erp/wms/bill/checkStockProfit';

    export default {
        name: "check_stock_profit",
        components: {
        ...
        methods: {
            ...
            handleAdd() {
                this.handleBillAdd(this,{path: '/check_stock_profit_from', name: '盘盈入库单制单'});
            },
            handleSwitchChange() {
                this.isShow = false;
                this.$nextTick(() => {
