...
<script>
    import {selectPage, selectPageByItem, batchDelBill} from '@/api/erp/wms/bill/checkStockLoss';

    export default {
        name: "check_stock_loss",
        props: ['timeStamp'],
        components: {
        ...
        methods: {
            ...
            handleAdd() {
                this.handleBillAdd(this,{path: '/check_stock_loss_from', name: '盘亏出库单制单'});
            },
            handleSwitchChange() {
                this.isShow = false;
                this.$nextTick(() => {
