...
<script>
    import {batchDelBill, selectPage, selectPageByItem} from "@/api/erp/wms/bill/stockModify";

    const stockFormOption = [
        {value: '良品', label: '良品'},
        {value: '次品', label: '次品'},
        {value: '废品', label: '废品'}
    ];
    export default {
        ...
        methods: {
            ...
            handleAdd() {
                this.handleBillAdd(this, {path: '/stock_modify_form', name: '库存修改单制单'});
            },
            handleSwitchChange() {
                this.isShow = false;
                this.$nextTick(() => {
                ...
                select(queryObj).then(res => {
                    ...
                    if (this.isDetailed) {
                        for (let i in data.records) {
                            ...
                            data.records[i].operatorName = data.records[i].mainDTO.operatorName;
