...
<script>
    import {page as pages, addObj, getObj, delObj, putObj, updateStatus} from '@/api/erp/financial/financialReceiptType';
    export default {
        props: ['timeStamp'],
        name: "receipt_type",
        components: {
        ...
        methods: {
            ...
            handleAdd() {
                this.handleBillAdd(this,{path: '/receipt_type_form', name: '收款类型制单'});
            },
        }
    }
</script>
