...
<script>
    import {page as pages, addObj, getObj, delObj, putObj, updateStatus} from '@/api/erp/financial/financialPayType';
    ...
    export default {
        ...
        methods: {
            ...
            handleAdd() {
                this.handleBillAdd(this, {path: '/payment_type_form', name: '付款类型制单'});
            },
        }
    }
</script>
