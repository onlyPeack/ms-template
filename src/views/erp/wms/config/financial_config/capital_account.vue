<template>
    <list-container :timeStamp="timeStamp" :page="page" @reload="getList">
        ...
        <el-dialog :visible.sync="budgetVisible" v-if="budgetVisible" width="50%"
                   ...
                   :before-close="handleBudgetClose" :title="this.budgetForm.id ? '修改银行账户':'新增银行账户'" append-to-body
...
<script>
    import {page as pages, addObj, getObj, delObj, putObj, updateStatus} from '@/api/erp/financial/financialBankAccount';
    export default {
