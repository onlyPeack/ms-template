...
<script>
    import { addObj, getObj, delObj, putObj} from '@/api/erp/financial/financialCapitalAccount';

    export default {
        name: "company_account_form",
        props: ['type', 'id'],
        components: {
                    ...
                    column:
                        [
                            ...
                            },
                            {
                                ...
                                align: 'center',
                                dicMethod: 'get',
                                dicUrl: '/api/dict/dictValue/dictType/comm_company_account',
                                props: {
                                    value: 'id',
                                    label: 'labelDefault'
                                },
