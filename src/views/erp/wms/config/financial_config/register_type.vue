<template>
    <list-container :timeStamp="timeStamp" :page="page" @reload="getList">
        ...
        <el-dialog :visible.sync="budgetVisible" v-if="budgetVisible" width="35%"
                   ...
                   :before-close="handleBudgetClose" :title="this.budgetForm.id ? '修改费用类型':'新增费用类型'" append-to-body
...
<script>
    import {page as pages, addObj, getObj, delObj, putObj, updateStatus} from '@/api/erp/financial/registerType';
