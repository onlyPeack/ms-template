    ...
    <div class="contractPrintContainer" :style="{width:containerWidth}" style="overflow: auto;">
        <div class="print-box" id="printBox">
            <div class="print-container">
                ...
                <div class="print-title">领料出库单</div>
                ...
                <table class="formTable itemsTable">
                    ...
                    <tr v-for="(scope,index) in items">
                        ...
                        <td align="right">{{scope.orderQty}}</td>
                        <td align="right">{{scope.pickingOutQty}}</td>
...
<script>
    ...
    import {addBill, getBill, tempAddBill, auditBill} from '@/api/erp/wms/bill/materialStockOut';
