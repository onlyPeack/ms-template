<template>
    <list-container :timeStamp="timeStamp" :page="page" @reload="getList">
            ...
            <div class="avue-crud-container" v-if="isShow">
                <avue-crud ref="crud"
                    ...
                    <template slot="opt" slot-scope="scope">
                        <el-switch v-model="scope.row.isDefault" :active-value="0"
        ...
        <el-dialog :visible.sync="budgetVisible" v-if="budgetVisible" width="65%"
                   ...
                   :before-close="handleBudgetClose" :title="this.budgetForm.id ? '修改模板':'新增模板'" append-to-body
...
<script>
    ...
    import {page as pages, addObj, getObj, delObj, putObj, updateStatus} from '@/api/erp/config/contractTemplate';
