<template>
    <list-container :timeStamp="timeStamp" :page="page" @reload="getList">
        ...
        <el-dialog :visible.sync="budgetVisible" v-if="budgetVisible" width="35%"
                   ...
                   :before-close="handleBudgetClose" :title="this.budgetForm.id ? '修改供应商类别':'新增供应商类别'" append-to-body
...
<script>
    import {page as pages, addObj, getObj, delObj, putObj, updateStatus} from '@/api/erp/purchase/supplier/supplierType';
    export default {
        props: ['timeStamp'],
        name: "supplier_type",
        components: {
