<template>
    <list-container :timeStamp="timeStamp" :page="page" @reload="getList">
        ...
        <el-dialog :visible.sync="budgetVisible" v-if="budgetVisible" width="35%"
                   ...
                   :before-close="handleBudgetClose" :title="this.budgetForm.id ? '修改其它往来单位':'新增其它往来单位'" append-to-body
...
<script>
    import {page as pages, addObj, getObj, delObj, putObj, updateStatus} from '@/api/erp/financial/financialOtherCompany';
    export default {
        name: "other_contacts_company",
        components: {
