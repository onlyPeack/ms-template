<template>
    <div >
        ...
        <el-tree class="filter-tree" node-key="id" :data="mainTreeData" :props="defaultProps" default-expand-all :expand-on-click-node="false"
                 :filter-node-method="filterNode" ref="mainTree" @node-click="getTreeNodeData" style="max-height: 300px; overflow: auto;" highlight-current >
        </el-tree>
        <!-- </el-col>
      </el-row> -->
    </div>
...
<script>
    import {list} from "@/api/admin/group/index";
    ...
    export default {
        ...
        methods: {
            ...
            onSubmit() {
                this.$emit('closePositionDialog', this.currentTreeNode)
            }
        },
        created() {
