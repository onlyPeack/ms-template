<template>
    <div class="app-container calendar-list-container" style="padding: 10px;">
        <el-row>
            <el-col :span="6"><div class="grid-content bg-purple" style="margin-right: 10px">
            ...
            <el-col :span="18" style="height:100%"><div class="grid-content bg-purple-light">
                <el-card class="box-card" v-if="!editDictTypeFlag">
                    ...
                    <div>
                        <div class="filter-container">
                            ...
                            <el-button class="filter-item" type="primary" icon="search" style="margin-left: 10px;" @click="handleDictValueFilter">搜索</el-button>
                        ...
                        <el-table :data="dictValueTableData" border  highlight-current-row style="width: 100%;margin-top: 10px;">
                            <el-table-column
                                    label="操作"
                                ...
                                <template  slot-scope="scope">
                                    ...
                                    <el-button size="small" type="text" @click="handleDelete(scope.row)" style="color: red;margin-left: 0px;" v-if="dictValueManager_btn_del"><i class="el-icon-delete"></i>
                                    </el-button>
                                </template>
                            </el-table-column>
                        ...
                        <div class="pagination-container">
                            <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange"
                                           :current-page="listDictValueQuery.page"
                                           :page-sizes="[10,20,30,50]" :page-size="listDictValueQuery.limit"
        ...
        methods: {
            handleSizeChange(val) {
                ...
                page(this.listDictValueQuery).then(response => {
                    this.dictValueTableData = response.data.data.rows
                    this.total = response.data.total
                });
            },
            handleCurrentChange(val) {
                this.listDictValueQuery.page = val;
                page(this.listDictValueQuery).then(response => {
                    this.dictValueTableData = response.data.data.rows
                    this.total = response.data.total
                });
            ...
            edit(node, data) {
                ...
                getTypeObj(data.id).then(response => {
                    this.dictTypeForm = response.data.data;
                });
                this.$refs.dictTypeTree.setCurrentKey(data.id);
            },
            resetDictTypeForm() {
