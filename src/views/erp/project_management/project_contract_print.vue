        ...
        <div class="bill-print-container" :style="{width:containerWidth}">
            <div class="print-box" id="printBox" ref="print">
                <div class="print-container">
                    <div class="print-top">
                        <div class="print-title">{{data.contractName}}项目合同</div>
                    ...
                    <div class="print-table">
                        <table v-if="itemsList.length<1" class="formTable itemsTable hiddenTable">
                            ...
                            <tr v-for="(scope,index) in items">
                                ...
                                <td width="10%" align="right">{{scope.price}}</td>
                                <td width="10%" align="right">{{scope.amount}}</td>
                            </tr>
                            <tr>
                                <td>合计</td>
                                <td colspan="5"></td>
...
<script>
    ...
    import {getBill, contractPrint, getDefault} from '@/api/erp/project_management/projectOverview';
    import "@/styles/print.scss";
    import {getFloat} from '@/util/util'

    export default {
        name: "project_contract_print",
        data() {
            return {
