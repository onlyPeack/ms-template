<template>
    <list-container :timeStamp="timeStamp" :page="page" @reload="getList">
        ...
        <el-dialog :visible.sync="budgetVisible" v-if="budgetVisible" width="35%"
                   ...
                   :before-close="handleBudgetClose" :title="this.budgetForm.id ? '修改客户属性':'新增客户属性'" append-to-body
    ...
    export default {
        ...
        methods: {
            ...
            handleSwitchChange(val, row, index) {
                ...
                this.form = row;
                this.form.type = 'customer_attribute';
            ...
            handleSearchChange(params) {
                ...
                this.listQuery.type='customer_attribute';
                this.page.currentPage = 1;
