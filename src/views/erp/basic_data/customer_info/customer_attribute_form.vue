...
<script>
    import { addObj, getObj, delObj, putObj} from '@/api/erp/crm/customerType';
    var DIC = {
        status: [{
            value: '0',
            label: '开启'
        ...
        methods: {
            ...
            init() {
                ...
                if (this.id) {
                    ...
                    this.vueSet(this, 'formData', {status:'0',type: "customer_attribute"});
                    this.loading = false;
